...
def merge_labels(layers):
    ...
    for layer in layers[1:, :, :]:
        ...
        # Remove labels from layer and reassign current labels (Don't count labels == 0). (The if-else statement can be skipped if segmented layers do not have repeat labels)
